...
export default function EbookElvisionPaymentPage() {
  ...
  const handleCreatePayment = async () => {
    ...
    try {
      const { data, error } = await supabase.functions.invoke('tripay-create-payment', {
        body: {
          subscriptionType: 'ebook_elvision',
  ...
  useEffect(() => {
    ...
    const channelName = `payment-status-elvision-${paymentData.tripay_reference}`;
    
    console.log(`[EbookElvisionPaymentPage] Attempting to subscribe to channel: ${channelName} for tripay_reference: ${paymentData.tripay_reference}`);
        ...
        (payload) => {
          ...
          if (payload.new?.status === 'PAID') {
            ...
            toast({
                ...
                description: "Terima kasih, pembayaran Anda telah kami terima. Silakan cek email Anda di Inbox, Important, atau Spam untuk link Ebook eL Vision.",
                duration: 0, 
            });
            ...
            console.log(`[EbookElvisionPaymentPage] Payment status is not PAID. Current status: ${payload.new?.status}`);
          }
        }
      ).subscribe((status) => {
        console.log(`[EbookElvisionPaymentPage] Supabase channel status for ${channelName}:`, status);
        if (status === 'SUBSCRIBED') {
          console.log(`[EbookElvisionPaymentPage] Successfully SUBSCRIBED to ${channelName}`);
        }
      });
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                {paymentData.paymentMethod === 'BCA_MANUAL' && paymentData.status === 'UNPAID' && (
                  <div className="my-12">
                    <a
                      href={`https://wa.me/62895325633487?text=${encodeURIComponent(`Halo kak, saya sudah melakukan transfer manual BCA untuk pesanan Ebook eL Vision.<br/><br/>` + 
    ...
    <div className="min-h-screen bg-background pb-32">
      ...
      <div className="px-6 space-y-6">
        <Card className="mb-6 bg-gray-800 text-white">
          <CardHeader>
            <CardTitle className="text-xl">Deskripsi Produk</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4 font-bold">
            <p>eBook ini ditulis ringkas, langsung praktik, dan telah membantu ribuan orang.</p>
            <p>Bukan sekadar bacaan, ini adalah paket transformasi eL Vision.</p>
            <div>
            ...
            <p>Seluruh masalah yang Anda hadapi pada dasarnya merupakan akumulasi kondisi internal yang tidak selaras.</p>
            <p>Penelitian Dr. Masaru Emoto menunjukkan bahwa frekuensi memengaruhi air—dan lebih dari 90% tubuh manusia terdiri dari air.</p>
            <p>eL Vision bekerja langsung pada tubuh, emosi, dan alam bawah sadar, bukan sekadar di pikiran.</p>
          </CardContent>
        </Card>
