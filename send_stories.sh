...
# Function to send photo and then text
send_story() {
  local photo_path="$1"
  local title="$2"
  local text="$3"
  
  echo "Sending photo for $title..."
...
# STORY 1
send_story "$DIR/angle1-Silent_Power.webp" "👑 <b>Mengapa Pria Menjadi Pelit Perhatian?</b>" \
"Hai ladies, untuk kamu yang bermasalah dengan doi yang pelit banget perhatian, ini nih akarnya, tau gak?
...
# STORY 2
send_story "$DIR/istritest3-Suami_Perhatian_HP.webp" "👑 <b>Mengapa Suami Menjadi Sangat Cuek Setelah Menikah Lama?</b>" \
"Untuk kamu ladies yang bermasalah dengan suami yang cuek, dingin, dan lebih asyik dengan HP atau game daripada mengobrol denganmu, ini nih akarnya, tau gak?
...
# STORY 3
send_story "$DIR/df06_fuckboy_cycle.webp" "👑 <b>Mengapa Doi Tiba-tiba Ghosting Padahal Awalnya Manis?</b>" \
"Halo ladies, untuk kamu yang bermasalah dengan doi yang tiba-tiba pelit banget perhatian, ghosting, dan menarik diri padahal awalnya super manis, ini nih akarnya, tau gak?
...
# STORY 4
send_story "$DIR/winner-Stop_Jadi_Opsi-SENT.webp" "👑 <b>Mengapa Kamu Diperlakukan Sebagai Pilihan Kedua?</b>" \
"Dear ladies, untuk kamu yang bermasalah dengan pasangan yang pelit banget perhatian padamu tapi justru \"royal\" ke orang lain atau wanita lain, ini nih akarnya, tau gak?
...
# STORY 5
send_story "$DIR/angle6-Tidak_Pernah_Minta.webp" "👑 <b>Mengapa Kamu Selalu Mendapat Pasangan yang Pasif & Benalu?</b>" \
"Hai ladies yang tangguh, untuk kamu yang selalu dapet pasangan yang pelit inisiatif, pasif, dan justru kamu yang malah jadi \"provider\" dalam hubungan, ini nih akarnya, tau gak?
...
# STORY 6
send_story "$DIR/df04_teman_curhat.webp" "👑 <b>Mengapa Doi Hanya Menjadikanmu Teman Curhat (Friendzone)?</b>" \
"Untuk kamu ladies yang terjebak <i>friendzone</i> dengan doi yang pelit banget perhatian romantis dan cuma menganggapmu pendengar setia keluh kesahnya, ini nih akarnya, tau gak?
...
# STORY 7
send_story "$DIR/winner-Satu_Perubahan-SENT.webp" "👑 <b>Mengapa Omelan dan Protesmu Justru Membuat Doi Makin Menjauh?</b>" \
"Hai ladies, untuk kamu yang bermasalah dengan suami yang pelit perhatian dan setiap kali kamu memprotes sikap cueknya, dia malah semakin marah dan menjauh, ini nih akarnya, tau gak?
...
# STORY 8
send_story "$DIR/df09_wake_up_call.webp" "👑 <b>Mengapa Kamu Terus Menerus Terjebak dengan Pria Toxic dan Kasar?</b>" \
"Untuk kamu ladies yang bermasalah karena selalu kembali ke pelukan pria toxic, manipulatif, dan sering menyiksamu dengan tarik-ulur emosional, ini nih akarnya, tau gak?
...
# STORY 9
send_story "$DIR/df02_2am_scroll.webp" "👑 <b>Mengapa Hubunganmu Selalu Mandek di Status 'Jalani Aja Dulu'?</b>" \
"Hai ladies, untuk kamu yang terjebak dalam hubungan tanpa status, mengambang, dan penuh ketidakpastian (HTS), ini nih akarnya, tau gak?
...
# STORY 10
send_story "$DIR/df08_secret_she_knows.webp" "👑 <b>Mengapa Pasangan Berani Berkata Kasar dan Merendahkanmu?</b>" \
"Dear ladies, untuk kamu yang bermasalah dengan pasangan yang lidahnya tajam, sering merendahkan usahamu, membanding-bandingkanmu, dan berkata sangat dingin, ini nih akarnya, tau gak?
...
echo "Done sending 10 long stories!"
